package com.blhx.book_managers.biz;

import com.blhx.book_managers.model.Ticket;
import com.blhx.book_managers.model.User;
import com.blhx.book_managers.model.exceptions.LoginReginisterException;
...
import com.blhx.book_managers.utils.MD5;
import com.blhx.book_managers.utils.TicketUtils;
...
public class LoginBiz {
    ...
    public String login(String email,String password) {
        ...
        //登录信息检查
        if (user ==null)
            throw new LoginReginisterException("邮箱不存在");
        if (!StringUtils.equals(MD5.next(password),user.getPassword()))
            throw new LoginReginisterException("密码不正确");
